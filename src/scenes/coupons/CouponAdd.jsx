    ...
    if (productIds.length === 0 && categoryIds.length === 0) {
      ...
      const handleSubmit=async()=>{
        ...
        const isoEndDate = new Date(endDate).toISOString();
          ...
          const response=await couponApi.add(data)
    ...
    <ContentMain>
      <div className="row">
        ...
        <div className='row'>
              ...
              <MultiSelect value={categoryIds} onChange={(e) => handleSelectCategory(e)} options={categoryData} optionLabel="name" 
                filter placeholder="Chọn danh mục" maxSelectedLabels={3} style={{ width:"100%" }} />
              </div>
        <div className='col-md-6'>
        <MultiSelect value={productIds} options={tempPData} onChange={(e) => setProductIds(e.value)} optionLabel="name" 
